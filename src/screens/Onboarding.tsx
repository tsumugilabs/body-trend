import type { BodyRecord, GoalSettings, TrainingRecord } from '../types';
...
export function Onboarding({ today, records, trainings, notify, onSubmit, onRestore, onLoadSample }: Props) {
  return (
